...
public interface SysRoleMapper extends BaseMapper<SysRole> {
     ...
     * @return 结果
     */
    int selectCountRoleById(Long roleId);
     ...
     * @return 结果
     */
    int deleteUserRoleInfos(@Param("userIds") Long[] userIds, @Param("roleId") Long roleId);
     ...
     * @return 结果
     */
    int batchInsertRoleUser(@Param("roleId") Long roleId, @Param("userIds") List<Long> userIds);
}